...
var gamePlay = {
    ...
    playGame: function() {
        ...
        const usernameAJAX = this.getUsername(); // Get the username from the URL
        setUsername(usernameAJAX);
    ...
    isGameOver: function() {
        ...
        if (blackjack.player.userWallet.getValue() < 100) {
            window.socketHandler.sendMoveToServer(playerNumber, 'gameover');
